    ...
    _createClass(ProductItemColorSwatch, [{
      ...
      value: function _colorChanged(event, target) {
        ...
        var productItem = target.closest('.ProductItem'),
            productHandle = target.getAttribute('data-product-handle'),
        ...
        // Set the quick buy id
        document.getElementById('quick-buy-'.concat(productHandle)).value = variantId;
        console.log(document.getElementById('quick-buy-'.concat(productHandle)).value);
      }
    }]);
